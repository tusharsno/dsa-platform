...
//   return (
//     // theme-ready background and text
//     <div className="bg-white dark:bg-[#030712] min-h-screen text-slate-900 dark:text-slate-200 transition-colors duration-500">
//       <Workspace problem={problem} />
//     </div>
//   );
// }
...
//   return (
//     // Theme-ready background for Workspace
//     <div className="bg-white dark:bg-[#030712] min-h-screen text-slate-900 dark:text-slate-200 transition-colors duration-500 pt-16">
//       <Workspace problem={problem} />
//     </div>
//   );
// }
