...
export default function RootLayout({
  ...
  // ১. ড্যাশবোর্ড পেজের জন্য চেক (এখানে Navbar বা Footer কিছুই থাকবে না)
  const isDashboard = pathname.startsWith("/dashboard");

  // ২. মিনিমাল পেজ চেক (Topics, Problems, Roadmap - এখানে Navbar থাকবে কিন্তু Footer থাকবে না)
  const isMinimalUI =
    pathname.startsWith("/topics") ||
    pathname.startsWith("/problems") ||
    pathname.startsWith("/roadmap");
    ...
    <ClerkProvider>
      <html lang="en" suppressHydrationWarning>
        <body
          className={cn(
            inter.className,
            "bg-[#020617] selection:bg-blue-500/30",
          )}
        >
          <ThemeProvider attribute="class" defaultTheme="dark" enableSystem>
            {/* কন্ডিশন: ড্যাশবোর্ড না হলেই কেবল ন্যাভবার দেখাবে (Home, Topics, Problems সবখানে থাকবে) */}
            {!isAdminPage && !isDashboard && <Navbar />}

            <main className="min-h-screen">{children}</main>

            {/* কন্ডিশন: ড্যাশবোর্ড এবং মিনিমাল পেজ (Topics/Problems/Roadmap) না হলেই কেবল ফুটার দেখাবে */}
